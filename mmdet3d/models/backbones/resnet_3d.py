...
Date: 2023-09-13 07:21:44
Email: haimingzhang@link.cuhk.edu.cn
Description: Adapted from the FBOCC.
'''
...
try:
    ...
    Warning('Please install spconv with '
            '"pip install spconv -f '
            '" to enable sparse convolution support.')
...
class CustomResNet3DFBOCC(BaseModule):
    def __init__(self,
                 depth,
