...
Date: 2023-07-27 17:00:56
Email: haimingzhang@link.cuhk.edu.cn
Description: Using the instance mask to compute the constrastive loss.
'''
...
class MyBEVStereo4DOCCNeRF(BEVStereo4D):
    ...
    def __init__(self,
                 ...
                 use_semantic_constras_loss=False,
                 **kwargs):
        ...
        self.use_semantic_constras_loss = use_semantic_constras_loss
    ...
    def get_intermediate_features(self, 
        ...
        if self.NeRFDecoder.mask_render:
            ...
            if self.use_semantic_constras_loss:
                assert 'instance_mask' in kwargs.keys()
                instance_mask = instance_mask[render_mask]  # to (N,)
                internal_feats_dict['instance_mask'] = instance_mask
