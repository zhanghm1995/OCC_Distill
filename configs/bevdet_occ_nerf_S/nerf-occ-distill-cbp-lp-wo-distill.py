...
Date: 2023-07-29 22:50:15
Email: haimingzhang@link.cuhk.edu.cn
Description: Train the student model in the distillation framework, just for
validation.
'''
...
model = dict(
    ...
    occ_distill_head=dict(
        ...
        loss_semantic_align_weight=0.0,
        depth_loss_type='sml1',
        loss_depth_align_weight=0.0,
        variance_focus=0.85,
        depth_range=grid_config['depth'][:2])
)
