...
Date: 2023-09-20 11:32:46
Email: haimingzhang@link.cuhk.edu.cn
Description: Fuse the lidar point cloud in 3D BEV with the camera 
3D BEV voxels for occupancy prediction with the occupancy supervisioin in
lidar branch.
'''
...
model = dict(
    type='BEVFusionOCCLidarSupervise',
    se=True,
    lic=384,
    fuse_3d_bev=True,
    num_classes=18,
