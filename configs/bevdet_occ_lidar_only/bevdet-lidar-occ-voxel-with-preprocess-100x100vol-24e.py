...
Date: 2023-09-14 10:48:47
Email: haimingzhang@link.cuhk.edu.cn
Description: Output the 100x100 resolution volume and with the gt occupancy preprocessing.
'''
...
train_pipeline = [
    dict(type='LoadOccGTFromFileFBOCC'),
    dict(
    ...
    # dict(type='PointsConditionalFlipFBOCC'),
