...
Date: 2023-10-31 20:59:55
Email: haimingzhang@link.cuhk.edu.cn
Description: Using the density branch and semantic branch like RenderOcc, but in
this config we use the 3D occupancy loss to train the model.
'''
