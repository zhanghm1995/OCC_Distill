...
Date: 2023-11-14 00:56:21
Email: haimingzhang@link.cuhk.edu.cn
Description: Rendering the depth and instance align semantics separately.
Means we render the depth by using the original lidar point cloud, and render the
instance align loss with the sample_pts.
'''
...
model = dict(
    type='BEVStereo4DOCCTemporalNeRFPretrainV4',
...
# Data
dataset_type = 'NuScenesDatasetOccPretrainV2'
