...
Date: 2024-05-16 12:09:23
Email: haimingzhang@link.cuhk.edu.cn
Description: Use blance class weight, sperate prediction head, lovasz loss, and SSCNet.
'''
...
model = dict(
    ...
    balance_cls_weight=False,  # NOTE: we use hard code to use balance_cls_weight in BEVStereo4DOCCOpenSceneV2
